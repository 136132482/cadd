...
public:
    ...
    static std::string PostMultipartForm(const std::string& url,
                                         const FormData& form_data,
                                         const Headers& headers = {});
    // 在头文件中添加声明
    static std::future<std::string> AsyncUpload(const std::string& url,
                                         const std::string& filePath,
                                         const std::string& fieldName = "file");

    static void UploadAsync(const std::string& url,
                     const std::string& filePath,
