#include "util/AIGCJson.hpp"
#include "util/MyObject.h"
...
int main()
{
    ...
    cout<<my.students.begin()->grade<<endl;

    cout<<my.master.name<<endl;

    bool check= JsonHelper::JsonToObject(my, sjson,{"num"});
